...
const STRINGS = {
  en: {
    ...
    'inputs.hint': 'Name each amount, say whether it comes in or goes out, how often it lands, and how much.',
  ...
  fr: {
    ...
    'inputs.hint': 'Nommez chaque montant, indiquez s’il entre ou s’il sort, à quelle fréquence il tombe, et combien.',
    ...
    'field.amount': 'Montant à chaque fois',
