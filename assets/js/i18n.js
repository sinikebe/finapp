...
const STRINGS = {
  en: {
    ...
    'undo.aria.project': 'Undo removing a project',
    ...
    'undo.said.project': 'The project is back, with every plan that was in it.',
    ...
    // ------------------------------------------ the rental-property template
    // A template's rows go through the dictionary like any other default name,
    // so a project started from one follows the reader's language rather than
    // arriving frozen in whichever language they happened to press it in.
    'field.default.notary': 'Notary fees',
    'field.default.works': 'Renovation works',
    'field.default.furniture': 'Furnishing',
    'field.default.property': 'The flat',
    'field.default.rentReceived': 'Rent received',
    'field.default.vacancy': 'Vacancy',
    'field.default.coproCharges': 'Service charges',
    'field.default.lettingFees': 'Letting agent',
    'field.default.landlordInsurance': 'Landlord insurance',
    'field.default.rentGuarantee': 'Rent guarantee',
    'field.default.rentTax': 'Tax on the rents',
    'field.default.coproLiving': 'Service charges you cannot pass on',
    'field.default.homeInsurance': 'Home insurance',
    'field.default.rentElsewhere': 'Rent you pay elsewhere',
    // -------------------------------------------------- the car template
    'field.default.car': 'The car',
    'field.default.carPurchase': 'Buying the car',
    'field.default.carCredit': 'Car loan',
    'field.default.registration': 'Registration',
    'field.default.carInsurance': 'Car insurance',
    'field.default.fuel': 'Fuel',
    'field.default.servicing': 'Servicing and tyres',
    'field.default.firstRent': 'First payment',
    'field.default.leaseRent': 'Monthly payment',
    'field.default.returnFees': 'Charges for handing it back',
    // -------------------------------------------------------- the projects
    // A project is the question; a strategy is an answer to it. The copy holds
    // that line everywhere, because it is the whole of what a reader has to
    // learn to use this.
    'project.default.home': 'Buying a home',
    'project.default.liveOrLet': 'Live in it, or let it out',
    'project.default.car': 'Buy the car, or lease it',
    'project.heading': 'Projects',
    'project.note': 'A project is one question with several answers in it: its own plans, its own horizon, its own targets. How money behaves is shared by all of them.',
    'project.defaultName': (position) => `Project ${position}`,
    'project.add': 'Start another project',
    'project.nameAria': 'Name of this project',
    'project.namePlaceholder': 'Name this project',
    'project.switchAria': (name, count) => `Project: ${name}. Switch project, ${count} in all`,
    'project.switchAriaOnly': (name) => `Project: ${name}. Start another project`,
    'project.openNamed': (name) => `Open ${name}`,
    'project.removeNamed': (name) => `Remove the project ${name}`,
    'project.count': (plans, horizon) => `${plural(plans, '1 plan', `${plans} plans`)} · ${horizon}`,
    'share.receivedProject': 'Open as its own project',
    ...
    'strategy.default.liveIn': 'Live in it',
    'strategy.default.letLmnp': 'Let it out, writing it down',
    'strategy.default.letMicro': 'Let it out, flat allowance',
  ...
  fr: {
    ...
    'undo.aria.project': 'Annuler la suppression d’un projet',
    ...
    'undo.said.project': 'Le projet est de retour, avec tous les plans qu’il contenait.',
    ...
    'field.default.notary': 'Frais de notaire',
    'field.default.works': 'Travaux de rénovation',
    'field.default.furniture': 'Ameublement',
    'field.default.property': 'Le bien',
    'field.default.rentReceived': 'Loyer perçu',
    'field.default.vacancy': 'Vacance locative',
    'field.default.coproCharges': 'Charges de copropriété',
    'field.default.lettingFees': 'Frais de gestion',
    'field.default.landlordInsurance': 'Assurance PNO',
    'field.default.rentGuarantee': 'Garantie loyers impayés',
    'field.default.rentTax': 'Impôt sur les loyers',
    'field.default.coproLiving': 'Charges non récupérables',
    'field.default.homeInsurance': 'Assurance habitation',
    'field.default.rentElsewhere': 'Loyer que vous payez ailleurs',
    'field.default.car': 'La voiture',
    'field.default.carPurchase': 'Achat de la voiture',
    'field.default.carCredit': 'Crédit auto',
    'field.default.registration': 'Carte grise',
    'field.default.carInsurance': 'Assurance auto',
    'field.default.fuel': 'Carburant',
    'field.default.servicing': 'Entretien et pneus',
    'field.default.firstRent': 'Premier loyer majoré',
    'field.default.leaseRent': 'Loyer mensuel',
    'field.default.returnFees': 'Frais de restitution',
    // -------------------------------------------------------- les projets
    'project.default.home': 'Acheter un logement',
    'project.default.liveOrLet': 'Y habiter ou le louer',
    'project.default.car': 'Acheter la voiture ou la louer',
    'project.heading': 'Projets',
    'project.note': 'Un projet, c’est une question et les réponses qu’on lui donne : ses plans, son horizon, ses objectifs. Le comportement de l’argent, lui, est commun à tous.',
    'project.defaultName': (position) => `Projet ${position}`,
    'project.add': 'Commencer un autre projet',
    'project.nameAria': 'Nom de ce projet',
    'project.namePlaceholder': 'Nommez ce projet',
    'project.switchAria': (name, count) => `Projet : ${name}. Changer de projet, ${count} au total`,
    'project.switchAriaOnly': (name) => `Projet : ${name}. Commencer un autre projet`,
    'project.openNamed': (name) => `Ouvrir ${name}`,
    'project.removeNamed': (name) => `Supprimer le projet ${name}`,
    'project.count': (plans, horizon) => `${plans} plan${plans > 1 ? 's' : ''} · ${horizon}`,
    'share.receivedProject': 'Ouvrir comme projet à part',
    ...
    'strategy.default.liveIn': 'Y habiter',
    'strategy.default.letLmnp': 'Louer, au réel (LMNP)',
    'strategy.default.letMicro': 'Louer, au micro-BIC',
